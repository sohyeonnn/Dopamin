...
- 도파민은 20여가지 OTT서비스 업체들의 콘텐츠 검색을 지원합니다.
  - 회원가입시 얻은 설문조사 정보를 통해 유저 개인별 추천 콘텐츠를 제공하는 서비스입니다.
  - 부가적으로 콘텐츠에 대해 소통할 수 있는 커뮤니티, 유저의 프로필을 꾸밀 수 있는 아이템을 판매하는 상점과 이를 착용할 수 있는 마이페이지 기능을 제공합니다.

### 핵심 기능 및 부가 기능
- 콘텐츠
  - OTT 콘텐츠 통합 검색
  - 유저 정보 및 통계 기반의 OTT 콘텐츠 추천
  - OTT 콘텐츠 한줄평 작성
  - OTT 콘텐츠 저장
- 회원
  - 회원가입 및 로그인
